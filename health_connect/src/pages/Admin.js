...
import { Divider, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, StackDivider, useDisclosure } from '@chakra-ui/react'
import {
  Card,
  CardHeader,
  CardBody,
          ...
          >
            ...
            <Stack>
              <CardBody>
                ...
                <Divider my="4" />
                <Heading size="sm">
                Languages: {doctor.qualification}
                </Heading>

                <Divider my="4" />
                <Heading size="sm">
                Sprecialized Treatements: {doctor.specializedTreatments.join(', ')}
                </Heading>
              </CardBody>
